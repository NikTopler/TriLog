INSERT INTO Countries (alpha2, continentCode, name, alpha3, number, fullName) VALUES
  ...
  ('KP', 'AS', "North Korea", 'PRK', '408', "Democratic People's Republic of Korea"),
  ('KR', 'AS', "South Korea", 'KOR', '410', "Republic of Korea"),
  ...
  ('SK', 'EU', "Slovakia", 'SVK', '703', "Slovakia (Slovak Republic)"),
  ...
  ('TR', 'AS', "Turkey", 'TUR', '792', "Republic of Türkiye"),
  ...
  ('UK', 'EU', "United Kingdom of Great Britain and Northern Ireland", 'GBR', '826', "United Kingdom of Great Britain & Northern Ireland"),
